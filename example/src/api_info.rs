...
pub fn get_api_info() -> Vec<ApiInfo> {
    vec![
        ...
        false, group_name : "Samoyed".to_string(), }, ApiInfo { method : "get"
        .to_string(), path : "/store/name".to_string(), base_path : "".to_string(),
        handler_fun : "get_store_name".to_string(), summary :
        ...
        false, group_name : "Store".to_string(), }
    ]
}
#[allow(dead_code)]
#[derive(Debug, Clone)]
